...
{
	if (type == 1)
		return sbuf[0][cur] == 0 && sbuf[1][cur] == 0 && cur + 1 < M
		    && sbuf[1][cur + 1] == 0;

	if (type == 2)
		return sbuf[0][cur] == 0 && sbuf[1][cur] == 0 && cur - 1 >= 0
		    && sbuf[1][cur - 1] == 0;
	...
	if (type == 4)
		return sbuf[0][cur] == 0 && cur + 1 < M && sbuf[0][cur + 1] == 0
		    && sbuf[1][cur + 1] == 0;
}
